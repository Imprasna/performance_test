...
const data = {
    ...
    datasets: [
        ...
        {
            data: [40, 80, 50, 80, 79, 89, 58, 90, 60, 19, 59, 29],
            label: 'Hello Dumps',
        ...
        {
            data: [30, 60, 20, 85, 59, 89, 98, 10],
            label: 'Kick Dumps',
            backgroundColor: 'rgb(110 10 132 / 50%)',
            borderColor: 'rgb(110, 10, 132)',
            // data: [0, 10, 5, 2, 20, 30, 45],
        },
        {
            data: [60, 80, 60, 80, 99, 89, 78, 90],
            label: 'Go Dumps',
            backgroundColor: 'rgb(205 105 132 / 50%)',
            borderColor: 'rgb(205, 105, 132)',
            // data: [0, 10, 5, 2, 20, 30, 45],
        },
    ],
}
